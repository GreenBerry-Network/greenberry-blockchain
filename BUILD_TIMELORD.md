...
required to run a [Timelord](https://github.com/GreenBerry-Network/greenberry-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/GreenBerry-Network/greenberry-blockchain/blob/main/install-timelord.sh)
