...
from greenberry.server.ssl_context import greenberry_ssl_ca_paths, private_ssl_ca_paths
...
class Service:
    def __init__(
        ...
        proctitle_name = f"greenberry_{service_name}"
        ...
        greenberry_ca_crt, greenberry_ca_key = greenberry_ssl_ca_paths(root_path, self.config)
        inbound_rlp = self.config.get("inbound_rate_limit_percent")
        outbound_rlp = self.config.get("outbound_rate_limit_percent")
        assert inbound_rlp and outbound_rlp
        self._server = GreenBerryServer(
            advertised_port,
            node,
            peer_api,
            node_type,
            ...
            (greenberry_ca_crt, greenberry_ca_key),
    ...
    async def wait_closed(self) -> None:
        ...
        self._log.info("Waiting for GreenBerryServer to be closed")
