...
from greenberry.consensus.pot_iterations import calculate_iterations_quality, calculate_sp_interval_iters
from greenberry.harvester.harvester import Harvester
from greenberry.plotting.plot_tools import PlotInfo, parse_plot_info
from greenberry.protocols import harvester_protocol
from greenberry.protocols.farmer_protocol import FarmingInfo
from greenberry.protocols.protocol_message_types import ProtocolMessageTypes
from greenberry.server.outbound_message import make_msg
...
from greenberry.util.api_decorators import api_request, peer_required
from greenberry.util.ints import uint8, uint32, uint64
from greenberry.wallet.derive_keys import master_sk_to_local_sk
...
class HarvesterAPI:
    ...
    async def new_signage_point_harvester(
        self, new_challenge: harvester_protocol.NewSignagePointHarvester, peer: WSGreenBerryConnection
    ):
        """
